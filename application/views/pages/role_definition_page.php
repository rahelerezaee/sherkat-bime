...
ثبت با موفقیت انجام شد
    ...
    <form method="post" action="<?php echo base_url(); ?>role_page/insert_new_role_per" onsubmit="cal()">
        <?php if(!empty($session['new_role_manager_per'])): ?>

        <div class="row">
            <div class="col-md-6 col-md-offset-3 col-xs-12">
                <div class="input-group">
                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                    <input id="role_name" type="text" class="form-control" name="role_name" placeholder="نام نقش" value="<?php echo set_value('role_name'); ?>">
                </div>
            ...
            <div class="col-md-6 col-xs-12">
                ...
                <div class="well">
                    <ul class="treeview">
                        ...
                        <li><input type="checkbox"  name="permissions[]" value="kartable_per"> <label data-per="kartable_per0">کارتابل</label>
                            <ul>
        ...
        <div class="row">
            <?php if(!empty($session['new_role_manager_per'])): ?>
                <div class="col-xs-3">
                    <input type="submit" value="ثبت نقش" class="btn btn-info btn-block">
                </div>
            <?php endif;?>


            <?php if(!empty($session['registerd_role_display_manager_per'])): ?>
                <div class="col-xs-3">
                    <a href="<?php echo base_url(); ?>role_page/show_role_registered_display" class="btn btn-warning btn-block">مشاهده نقش های ثبت شده</a>
                </div>
            <?php endif;?>
        </div>
